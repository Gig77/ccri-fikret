...
t.vs.m <- read.delim("~/fikret/results/patients-919-644.T-vs-M.deseq2.tsv", check.names=F, stringsAsFactors=F)
t.vs.d <- read.delim("~/fikret/results/patients-919-644.T-vs-D.deseq2.tsv", check.names=F, stringsAsFactors=F)
d.vs.m <- read.delim("~/fikret/results/patients-919-644.D-vs-M.deseq2.tsv", check.names=F, stringsAsFactors=F)
