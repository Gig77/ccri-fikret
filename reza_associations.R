...
c <- read.delim("/data_synology/christian/reza/Samples_Reza-v2.txt", na.strings=c("", "NA", "n/a", "N/A", "n/d", " "), check.names=F)
...
pdf("/mnt/projects/fikret/results/reza_associations.type1.pdf")
...
pdf("/mnt/projects/fikret/results/reza_associations.type2.pdf")
